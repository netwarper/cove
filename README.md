...
| **Resizable task lists** | Long **Overdue & Today** and **Upcoming** lists scroll at a capped height (so they don't push the page down); drag the grip below either to resize, double-click to reset — each list's size is persisted separately. |
